	...
	return (
		<div className='flex justify-center mt-8'>
			<form className='flex gap-5 bg-transparent p-4'>
				<input onChange={handleChange}  name='search' placeholder={search ? `Last Search: ${search}` : 'Search something'} className='h-14 w-[600px] placeholder:italic placeholder:text-white text-white text-3xl rounded-lg bg-blue-400 p-4' />
